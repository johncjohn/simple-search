...
class Program(Base):
    ...
    programid = Column(String(10), primary_key=True)
    programname = Column(String(50))
    programcategory = Column(String(10))
    specname = Column(String(50))
    programdepartmenttid = Column(String)
    intake = Column(Integer)
    genno = Column(Integer)
    obcno = Column(Integer)
    oecno = Column(Integer)
    muslimno = Column(Integer)
    scno = Column(Integer)
    stno = Column(Integer)
    latinno = Column(Integer)
    ecsno = Column(Integer)
    phyno = Column(Integer)
    noofsemesters = Column(Integer)
    order1 = Column(String(50))
    orderdate1 = Column(DateTime)
    order2 = Column(String(50))
    orderdate2 = Column(DateTime)
    order3 = Column(String(50))
    orderdate3 = Column(DateTime)
    startdate = Column(DateTime)
    programremarks = Column(String(200))